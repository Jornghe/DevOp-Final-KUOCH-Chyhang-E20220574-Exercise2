...
--
-- Host: db    Database: B-KUOCH_Chyhang-db
-- ------------------------------------------------------
...
INSERT INTO `templates` VALUES (1,'BLUE_STUDENT','VERTICAL','Blue Student Card','National University','#1d4ed8','#dbeafe','Knowledge is Power','#1e3a5f'),(2,'GREEN_EMPLOYEE','HORIZONTAL','Green Employee Card','Acme Corporation','#15803d','#dcfce7','Excellence in Every Step','#14532d'),(3,'RED_CORPORATE','VERTICAL','Red Corporate Card','Corporate HQ','#b91c1c','#fee2e2','Leading the Way','#450a0a');
/*!40000 ALTER TABLE `templates` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'B-KUOCH_Chyhang-db'
--
...
-- Dump completed on 2026-06-17 10:56:32
